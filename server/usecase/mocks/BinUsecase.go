...
// BinUsecase is an autogenerated mock type for the BinUsecase type
type BinUsecase struct {
	mock.Mock
}

// Add provides a mock function with given fields: name
func (_m *BinUsecase) Add(name string) (*domain.Bin, error) {
	ret := _m.Called(name)
...
func (_m *BinUsecase) Get(name string) (*domain.Bin, error) {
	ret := _m.Called(name)
...
func (_m *BinUsecase) GetByID(id int64) (*domain.Bin, error) {
	ret := _m.Called(id)
